...
function extractImagesFromContent(content) {
  ...
  // If content is an array (multimodal format)
...
function handleToolCall(message, antigravityMessages){
  // Find the corresponding functionCall name from prior model messages
  let functionName = '';
  ...
  // If the previous message is user with an existing functionResponse, merge them
